...
open class CombinedChartRenderer: DataRenderer
{
    ...
    /// if set to true, bars will be drawn wit rounded corners
    @objc open var drawRoundedBarsEnabled = true
    ...
    /// `true` if bars will be drawn with rounded corners, `false` if not
